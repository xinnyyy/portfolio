                ...
                <Row fillWidth paddingTop="m" paddingLeft="0" gap="12" wrap>
                  ...
                  <Column flex={6}>
                    <Media
                      ...
                      radius="m"
                      sizes="600"
                      alt={about.intro.images[0].alt}
                      src={about.intro.images[0].src}
                    />
                  </Column>

                  {/* Right stacked images */}
                  <Column flex={6} gap="12">
                    {about.intro.images.slice(1).map((image, index) => (
                      <Media
                        key={index}
                        enlarge
                        radius="m"
