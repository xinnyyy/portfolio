...
**🌐 Live Website:**  
[Click here for the Website](https://bt3103-matchup.web.app)

**📂 GitHub Repository:**  
[Click here for the Github Repository](https://github.com/BT3103AppDev1/l1-finaltermproject-2425s2l1_group_07)

**Youtube Link**
[Click here for the Youtube Link](https://youtu.be/19eouBixT9o)

---
## Overview

**MatchUp** is a web-based sports networking platform designed to simplify how users find, organize, and join sports games.   Built as part of the **BT3103 Application Systems Development for Business Analytics** module, the platform connects players by **sport type, location, and experience level**, helping them discover games that suit their skill level and availability.
